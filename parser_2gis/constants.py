...
# Максимальный таймаут на один URL в секундах (30 минут)
# ОБОСНОВАНИЕ: 1800 секунд (30 минут) - разумный максимум для парсинга одной категории
# с большим количеством данных. Превышение может указывать на проблемы с сетью или зависание.
MAX_TIMEOUT: int = 1800

# Таймаут по умолчанию на один URL в секундах (1 минута)
