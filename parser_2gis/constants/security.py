...
# Максимальная длина JavaScript кода (100 KB — достаточно для большинства скриптов внедрения,
# включая XHR-обёртки и обработчики событий, но ограничивает потенциально опасные payloads)
