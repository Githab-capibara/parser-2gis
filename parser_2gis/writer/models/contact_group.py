...
class Contact(BaseModel):
    ...
    Атрибуты:
        type: Тип контакта. Возможные значения: `email`, `website`, `phone`,
               `fax`, `icq`, `jabber`, `skype`, `vkontakte`, `twitter`,
               `instagram`, `facebook`, `pobox`, `youtube`, `odnoklassniki`,
               `googleplus`, `linkedin`, `pinterest`, `whatsapp`, `telegram`,
               `viber`.
        value: Техническое значение контакта
               (например "Телефон в международном формате").
        text: Значение контакта для вывода на экран (например "e-mail Иванова").
        url: Ссылка на сайт или социальную сеть.
        print_text: Значение контакта для вывода на принтер
                    (например "e-mail Иванова").
