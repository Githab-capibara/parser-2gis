...
class BrowserSettingsScreen(Screen):  # type: ignore[type-arg]
    """Настройки браузера."""
...
class ParserSettingsScreen(Screen):  # type: ignore[type-arg]
    """Настройки парсера."""
        ...
        with Container(id="parser-settings-container"):
            ...
            with Vertical(classes="setting-row"):
                ...
                yield Input(
                    ...
                    value=str(PARSER_DEFAULTS_MAX_RECORDS),
                    type="integer",
                )
            ...
            with Vertical(classes="setting-row"):
                ...
                yield Input(
                    ...
                    value=str(PARSER_DEFAULTS_MAX_RETRIES),
                    type="integer",
                )
...
class OutputSettingsScreen(Screen):  # type: ignore[type-arg]
    """Настройки вывода."""
