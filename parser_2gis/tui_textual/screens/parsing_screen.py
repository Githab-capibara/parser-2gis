...
class ParsingScreen(Screen):  # type: ignore[type-arg]
    """Экран парсинга."""
    ...
    def on_mount(self) -> None:
        ...
        selected_city_names = self.app.selected_cities
        ...
        self.app.start_parsing(selected_cities, selected_cats)
