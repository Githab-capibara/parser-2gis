"""Parser2GIS — парсер сайта 2GIS для сбора данных об организациях.  # noqa: RUF002
...
from .protocols import CleanupCallback, LoggerProtocol, Parser, ProgressCallback, Writer
