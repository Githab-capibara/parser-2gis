...
from .constants import EXTERNAL_RATE_LIMIT_CALLS  # L6: rate limiting для внешних запросов
from .constants import EXTERNAL_RATE_LIMIT_PERIOD  # L6: rate limiting для внешних запросов
