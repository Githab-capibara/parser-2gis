...
# _validate_city_cached=1024 (было 2048) - оптимизировано для баланса
# памяти и производительности
# _validate_category_cached=1024 (было 2048) - оптимизировано для баланса
# памяти и производительности
# ОБОСНОВАНИЕ: Уменьшение размеров кэша снижает потребление памяти
