...
**Дата последней очистки:** 2026-04-03 (повторная очистка)
...
|---------|----------|
| Тестовых файлов | 110 |
| Тестовых функций | ~1505 |
| Тестовых классов | ~379 |
| Прошедших тестов | 1362 (95%) |
| Упавших тестов | 71 (нестабильные многопоточные + устаревшие) |
