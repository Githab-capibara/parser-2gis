...
class TestTypeHints:
    ...
    def test_type_alias(self):
        ...
        type_aliases = ["CitiesList", "CategoriesList", "UrlValidationResult"]
...
class TestDocumentation:
    ...
    def test_docstring_raises(self):
        ...
        # Arrange
        functions_that_raise = [config.Configuration.merge_with, cache.CacheManager.clear_batch]
        ...
        for func in functions_that_raise:
            ...
            has_raises = (
                "Raises:" in doc
                or "Исключения:" in doc
                or "raises" in doc.lower()
                or "Превышена" in doc
            )
...
class TestConstants:
    ...
    def test_constants_used(self):
        ...
        # Arrange
        source_files = [(cache, "cache.py"), (parallel_parser, "parallel_parser.py")]
