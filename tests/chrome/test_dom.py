...
class TestDOMNodeConstruction:
    ...
    def test_basic_construction(self, sample_dom_node) -> None:
    ...
    def test_attributes_parsed_from_list(self, sample_dom_node) -> None:
        """Атрибуты парсятся из списка в словарь."""
        assert sample_dom_node.attributes == {"class": "container", "id": "main"}

    def test_attributes_odd_list_raises(self) -> None:
...
class TestDOMNodeText:
    ...
    def test_text_returns_node_value(self) -> None:
    ...
    def test_text_includes_children(self, nested_dom_node) -> None:
...
class TestDOMNodeSearch:
    ...
    def test_search_parametrized(self, nested_dom_node, predicate, expected_count) -> None:
