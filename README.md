...
- 🧹 Очистка истёкшего JSON-кэша (TTL = 24 часа по mtime файлов)
...
- 🧹 **Очистка истёкшего файлового JSON-кэша** (по времени изменения файла, TTL = 24 часа)
...
| 💾 **Просмотр кэша** | Управление кэшем, статистика, очистка (в т.ч. истёкшего по TTL) |
