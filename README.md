...
**Примечание:** В текущей версии используется современный текстовый интерфейс (TUI) на основе pytermgui.

### Возможности

- 🏙️ Выбор городов из списка (204 города) с поиском
- 📂 Выбор категорий/рубрик (93 категории, 1786 рубрик) с поиском
- 📝 Ручной ввод URL
- 🔧 Настройки Chrome и парсера через формы
