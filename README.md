...
| Тестовое покрытие | 850+ автоматических тестов (95%+ покрытие) |
...
### Модуль tui_pytermgui/app.py — TUI приложение
...
7. **Исправление импортов pytermgui**
   - Категория: Критическая ошибка
