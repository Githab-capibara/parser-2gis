...
- **PySimpleGUI** — графический интерфейс (опционально; может отсутствовать в данной сборке)
...
Внимание: в текущей сборке репозитория GUI может отсутствовать. Раздел описывает опциональные возможности, если GUI реализован в вашей версии.
