...
### Добавлено
- **Новый тестовый файл** `testes/test_cli_arguments.py`: 13 тестов для проверки регистрации аргументов командной строки
- Тесты на валидацию аргументов парсера
- Тесты для предотвращения подобных ошибок в будущем

### Изменено
- Унифицированы ссылки на репозиторий GitHub (Githab-capibara)
- Улучшена структура документации
- Общее количество тестов: **330** (293 + 13 новых + 24 других)
