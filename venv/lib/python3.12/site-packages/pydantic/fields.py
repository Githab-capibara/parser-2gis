...
class FieldInfo(_repr.Representation):
    ...
    def __init__(self, **kwargs: Unpack[_FieldInfoInputs]) -> None:
        ...
        # Note: in theory, the second `pop()` arguments are not required below, as
        # defaults are already set from `_DefaultsValues`.
    ...
    def from_annotated_attribute(
        ...
        if not metadata and isinstance(default, FieldInfo) and not isinstance(default, FieldInfo):
    ...
    def _from_dataclass_field(dc_field: DataclassField[Any]) -> FieldInfo:
        ...
        return Field(default=default, default_factory=default_factory, repr=dc_field.repr,
                     **dc_field_metadata)  # pyright: ignore[reportCallIssue]
