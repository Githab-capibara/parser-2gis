        ...
        raise JsonSchemaValueException("" + (name_prefix or "data") + " must be object",
                                       ...
                                       definition={'$schema': 'http://json-schema.org/draft-07/schema#',
                                                   ...
                                                   'properties': {'build-system': {'type': 'object',
                                                                              ...
                                                                              'properties': {'name': {'type': 'string',
                                                                                             ...
                                                                                             'license': {'description': '`Project license <https://peps.python.org/pep-0621/#license>`_.',
                                                                                                         'oneOf': [{'type': 'string',
                                                                                                                   ...
                                                                                                                   {'type': 'object',
                                                                                                                    ...
                                                                                                                    'required': ['text']}]},
                                                                                             'license-files': {'description': 'Paths or globs to paths of license files',
                                                                                                               'type': 'array',
                                                                                                               'items': {'type': 'string'}},
                                                                                             'authors': {'type': 'array',
                                                                                             ...
                                                                                             'optional-dependencies': {'type': 'object',
                                                                                                                       ...
                                                                                                                       'patternProperties': {'^.+$': {'type': 'array',
                                                                                                                                                      'items': {'$ref': '#/definitions/dependency'}}}},
                                                                                             'import-names': {'description': 'Lists import names which a project, when installed, would exclusively provide.',
                                                                                                              'type': 'array',
                                                                                                              'items': {'type': 'string',
                                                                                                                        'format': 'import-name'}},
                                                                                             'import-namespaces': {'description': 'Lists import names that, when installed, would be provided by the project, but not exclusively.',
                                                                                                                   'type': 'array',
                                                                                                                   'items': {'type': 'string',
                                                                                                                             'format': 'import-name'}},
                                                                                             'dynamic': {'type': 'array',
                                                                                          ...
                                                                                          'setuptools': {'$schema': 'http://json-schema.org/draft-07/schema#',
                                                                                                         ...
                                                                                                         'properties': {'platforms': {'type': 'array',
                                                                                                                        ...
                                                                                                                        'package-data': {'$$description': ['Mapping from package names to lists of glob patterns.',
                                                                                                                                         ...
                                                                                                                                         'type': 'object',
                                                                                                                                         'additionalProperties': False,
                                                                                                                                         'propertyNames': {'anyOf': [{'$ref': '#/definitions/package-name'},
                                                                                                                                                                     {'const': '*'}]},
                                                                                                                                         'patternProperties': {'^.*$': {'type': 'array',
                                                                                                                                                                        'items': {'type': 'string'}}}},
                                                                  ...
                                                                  'dependency-groups': {'type': 'object',
                                                                                        'description': 'Dependency groups following PEP 735',
                                                                                        'additionalProperties': False,
                                                                                        'patternProperties': {'^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9._-]*[a-zA-Z0-9])$': {'type': 'array',
                                                                                                                                                                        'items': {'oneOf': [{'type': 'string',
                                                                                                                                                                                  'description': 'Python package specifiers following PEP 508',
                                                                                                                                                                                             'format': 'pep508'},
                                                                                                                                                                                            {'type': 'object',
                                                                                                                                                                                             'additionalProperties': False,
                                                                                                                                                                                             'properties': {'include-group': {'description': 'Another dependency group to include in this one',
                                                                                                                                                                                                                              'type': 'string',
    ...
    if data_is_dict:
        ...
        if "build-system" in data_keys:
            ...
            if data__buildsystem_is_dict:
                ...
                if data__buildsystem__missing_keys:
                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".build-system must contain " + (str(sorted(data__buildsystem__missing_keys)) + " properties"),
                                                   value=data__buildsystem,
                                                   name="" + (name_prefix or "data") + ".build-system",
                                                   definition={'type': 'object',
                                                               'description': 'Table used to store build-related data',
                ...
                if "requires" in data__buildsystem_keys:
                    ...
                    if not isinstance(data__buildsystem__requires, (list, tuple)):
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".build-system.requires must be array",
                ...
                if "build-backend" in data__buildsystem_keys:
                    ...
                    if not isinstance(data__buildsystem__buildbackend, (str)):
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".build-system.build-backend must be string",
                ...
                if data__buildsystem_keys:
                    raise JsonSchemaValueException(
                        "" + (
                            name_prefix or "data") + ".build-system must not contain " + str(data__buildsystem_keys) + " properties",
                        value=data__buildsystem,
                        name="" + (
        ...
        if "dependency-groups" in data_keys:
            ...
            if not isinstance(data__dependencygroups, (dict)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".dependency-groups must be object",
                                               value=data__dependencygroups,
                                               name="" + (name_prefix or "data") + ".dependency-groups",
                                               definition={'type': 'object',
                                                           'description': 'Dependency groups following PEP 735',
                                                           'additionalProperties': False,
                                                           'patternProperties': {'^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9._-]*[a-zA-Z0-9])$': {'type': 'array',
            ...
            if data__dependencygroups_is_dict:
                ...
                for data__dependencygroups_key, data__dependencygroups_val in data__dependencygroups.items():
                    if REGEX_PATTERNS['^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9._-]*[a-zA-Z0-9])$'].search(data__dependencygroups_key):
                        ...
                        if not isinstance(data__dependencygroups_val, (list, tuple)):
                            raise JsonSchemaValueException(
                                "" + (
                                    name_prefix or "data") + ".dependency-groups.{data__dependencygroups_key}".format(
                                    **locals()) + " must be array",
                                value=data__dependencygroups_val,
                                name="" + (
                                    name_prefix or "data") + ".dependency-groups.{data__dependencygroups_key}".format(
                                    **locals()) + "",
                                definition={
                        ...
                        if data__dependencygroups_val_is_list:
                            ...
                            for data__dependencygroups_val_x, data__dependencygroups_val_item in enumerate(
                                    data__dependencygroups_val):
                                ...
                                if data__dependencygroups_val_item_one_of_count1 < 2:
                                    try:
                                        if not isinstance(data__dependencygroups_val_item, (str)):
                                            raise JsonSchemaValueException("" +
                                                                           (name_prefix or "data")
                                                                           + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}]".format(**locals())
                                                                           + " must be string", value=data__dependencygroups_val_item, name=""
                                                                           + (name_prefix or "data")
                                                                           + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}]".format(**locals())
                                        ...
                                        if isinstance(data__dependencygroups_val_item, str):
                                            if not custom_formats["pep508"](data__dependencygroups_val_item):
                                                raise JsonSchemaValueException("" +
                                                                               (name_prefix or "data")
                                                                               + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}]".format(**locals())
                                                                               + " must be pep508", value=data__dependencygroups_val_item, name=""
                                                                               + (name_prefix or "data")
                                                                               + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}]".format(**locals())
                                ...
                                if data__dependencygroups_val_item_one_of_count1 < 2:
                                    try:
                                        if not isinstance(data__dependencygroups_val_item, (dict)):
                                            raise JsonSchemaValueException(
                                                "" + (
                                                    name_prefix or "data") + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}]".format(
                                                    **locals()) + " must be object",
                                                value=data__dependencygroups_val_item,
                                                name="" + (
                                                    name_prefix or "data") + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}]".format(
                                                    **locals()) + "",
                                                definition={
                                                    ...
                                                    'properties': {
                                                        'include-group': {
                                                            ...
                                                            'pattern': '^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9._-]*[a-zA-Z0-9])$'}}},
                                                rule='type')
                                        data__dependencygroups_val_item_is_dict = isinstance(
                                            data__dependencygroups_val_item, dict)
                                        if data__dependencygroups_val_item_is_dict:
                                            ...
                                            if "include-group" in data__dependencygroups_val_item_keys:
                                                ...
                                                data__dependencygroups_val_item__includegroup = data__dependencygroups_val_item[
                                                    "include-group"]
                                                if not isinstance(data__dependencygroups_val_item__includegroup, (str)):
                                                    raise JsonSchemaValueException(
                                                        "" + (
                                                            name_prefix or "data") + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}].include-group".format(
                                                            **locals()) + " must be string",
                                                        value=data__dependencygroups_val_item__includegroup,
                                                        name="" + (
                                                            name_prefix or "data") + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}].include-group".format(
                                                            **locals()) + "",
                                                        definition={
                                                ...
                                                if isinstance(data__dependencygroups_val_item__includegroup, str):
                                                    if not REGEX_PATTERNS['^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9._-]*[a-zA-Z0-9])$'].search(
                                                            data__dependencygroups_val_item__includegroup):
                                                        raise JsonSchemaValueException(
                                                            "" + (
                                                                name_prefix or "data") + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}].include-group".format(
                                                                **locals()) + " must match pattern ^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9._-]*[a-zA-Z0-9])$",
                                                            value=data__dependencygroups_val_item__includegroup,
                                                            name="" + (
                                                                name_prefix or "data") + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}].include-group".format(
                                                                **locals()) + "",
                                            ...
                                            if data__dependencygroups_val_item_keys:
                                                raise JsonSchemaValueException(
                                                    "" + (
                                                        name_prefix or "data") + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}]".format(
                                                        **locals()) + " must not contain " + str(data__dependencygroups_val_item_keys) + " properties",
                                                    value=data__dependencygroups_val_item,
                                                    name="" + (
                                                        name_prefix or "data") + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}]".format(
                                                        **locals()) + "",
                                ...
                                if data__dependencygroups_val_item_one_of_count1 != 1:
                                    raise JsonSchemaValueException(
                                        "" + (
                                            name_prefix or "data") + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}]".format(
                                            **locals()) + " must be valid exactly by one definition" + (
                                            " (" + str(data__dependencygroups_val_item_one_of_count1) + " matches found)"),
                                        value=data__dependencygroups_val_item,
                                        name="" + (
                                            name_prefix or "data") + ".dependency-groups.{data__dependencygroups_key}[{data__dependencygroups_val_x}]".format(
                                            **locals()) + "",
                ...
                if data__dependencygroups_keys:
                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".dependency-groups must not contain " + str(data__dependencygroups_keys) + " properties",
                                                   value=data__dependencygroups,
                                                   name="" + (name_prefix or "data") + ".dependency-groups",
                                                   definition={'type': 'object',
                                                               'description': 'Dependency groups following PEP 735',
                                       ...
                                       definition={'$schema': 'http://json-schema.org/draft-07/schema#',
                                                   ...
                                                   'properties': {'platforms': {'type': 'array',
                                                                  ...
                                                                  'package-data': {'$$description': ['Mapping from package names to lists of glob patterns.',
                                                                                   ...
                                                                                   'type': 'object',
                                                                                   'additionalProperties': False,
                                                                                   'propertyNames': {'anyOf': [{'$id': '#/definitions/package-name',
                                                                                                     'title': 'Valid package name',
                                                                                                                'description': 'Valid package name (importable or :pep:`561`).',
                                                                                                                'type': 'string',
                                                                                                                'anyOf': [{'type': 'string',
    ...
    if data_is_dict:
        ...
        if "platforms" in data_keys:
            ...
            if not isinstance(data__platforms, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".platforms must be array", value=data__platforms, name=""
                                               + (name_prefix or "data")
                                               + ".platforms", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
        ...
        if "provides" in data_keys:
            ...
            if not isinstance(data__provides, (list, tuple)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".provides must be array",
                                               ...
                                               definition={'$$description': ['Package and virtual package names contained within this package',
                                                                             '**(not supported by pip)**'],
                                                           'type': 'array',
                                                           'items': {'type': 'string',
                                                                     'format': 'pep508-identifier'}},
                ...
                for data__provides_x, data__provides_item in enumerate(data__provides):
                    if not isinstance(data__provides_item, (str)):
                        raise JsonSchemaValueException("" +
                                                       ...
                                                       + " must be string", value=data__provides_item, name=""
                                                       + (name_prefix or "data")
                                                       + ".provides[{data__provides_x}]".format(**locals())
        ...
        if "obsoletes" in data_keys:
            ...
            if not isinstance(data__obsoletes, (list, tuple)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".obsoletes must be array",
                                               ...
                                               definition={'$$description': ['Packages which this package renders obsolete',
                                                                             '**(not supported by pip)**'],
                                                           'type': 'array',
                                                           'items': {'type': 'string',
                                                                     'format': 'pep508-identifier'}},
                ...
                for data__obsoletes_x, data__obsoletes_item in enumerate(data__obsoletes):
                    if not isinstance(data__obsoletes_item, (str)):
                        raise JsonSchemaValueException("" +
                                                       ...
                                                       + " must be string", value=data__obsoletes_item, name=""
                                                       + (name_prefix or "data")
                                                       + ".obsoletes[{data__obsoletes_x}]".format(**locals())
                                                       + "", definition={'type': 'string', 'format': 'pep508-identifier'}, rule='type')
                    if isinstance(data__obsoletes_item, str):
                        if not custom_formats["pep508-identifier"](data__obsoletes_item):
                            raise JsonSchemaValueException("" +
                                                           (name_prefix or "data")
                                                           + ".obsoletes[{data__obsoletes_x}]".format(**locals())
                                                           + " must be pep508-identifier", value=data__obsoletes_item, name=""
                                                           + (name_prefix or "data")
                                                           + ".obsoletes[{data__obsoletes_x}]".format(**locals())
                                                           + "", definition={'type': 'string', 'format': 'pep508-identifier'}, rule='format')
        if "zip-safe" in data_keys:
            ...
            if not isinstance(data__zipsafe, (bool)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".zip-safe must be boolean",
                                               ...
                                               definition={'$$description': ['Whether the project can be safely installed and run from a zip file.',
                                                                             '**OBSOLETE**: only relevant for ``pkg_resources``, ``easy_install`` and',
                                                                             '``setup.py install`` in the context of ``eggs`` (**DEPRECATED**).'],
                                                           'type': 'boolean'},
                                               rule='type')
        if "script-files" in data_keys:
            ...
            if not isinstance(data__scriptfiles, (list, tuple)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".script-files must be array",
                                               ...
                                               definition={'$$description': ['Legacy way of defining scripts (entry-points are preferred).',
                                                                             'Equivalent to the ``script`` keyword in ``setup.py``',
                                                                             '(it was renamed to avoid confusion with entry-point based ``project.scripts``',
                                                                             'defined in :pep:`621`).',
                                                                             '**DISCOURAGED**: generic script wrappers are tricky and may not work properly.',
        ...
        if "eager-resources" in data_keys:
            ...
            if not isinstance(data__eagerresources, (list, tuple)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".eager-resources must be array",
                                               ...
                                               definition={'$$description': ['Resources that should be extracted together, if any of them is needed,',
                                                                             'or if any C extensions included in the project are imported.',
                                                                             '**OBSOLETE**: only relevant for ``pkg_resources``, ``easy_install`` and',
                                                                             '``setup.py install`` in the context of ``eggs`` (**DEPRECATED**).'],
                                                           'type': 'array',
            ...
            if data__packages_one_of_count2 != 1:
                raise JsonSchemaValueException(
                    "" + (
                        ...
                        " (" + str(data__packages_one_of_count2) + " matches found)"),
                    value=data__packages,
                    name="" + (
                            ...
                            if not data__packagedir_key_any_of_count3:
                                try:
                                    if data__packagedir_key != "":
                                        raise JsonSchemaValueException(""
                                                                       + (name_prefix or "data")
                                                                       + ".package-dir must be same as const definition: ", value=data__packagedir_key, name=""
                                                                       + (name_prefix or "data")
        ...
        if "package-data" in data_keys:
            ...
            if data__packagedata_is_dict:
                ...
                if data__packagedata_keys:
                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".package-data must not contain " + str(data__packagedata_keys) + " properties",
                                                   value=data__packagedata,
                                                   name="" + (name_prefix or "data") + ".package-data",
                                                   definition={'$$description': ['Mapping from package names to lists of glob patterns.',
                                                                                 'Usually this option is not needed when using ``include-package-data = true``',
                ...
                if data__packagedata_len != 0:
                    ...
                    for data__packagedata_key in data__packagedata:
                        try:
                            ...
                            if not data__packagedata_key_any_of_count4:
                                try:
                                    validate_https___setuptools_pypa_io_en_latest_userguide_pyproject_config_html__definitions_package_name(
                                        data__packagedata_key, custom_formats, (name_prefix or "data") + ".package-data")
                            ...
                            if not data__packagedata_key_any_of_count4:
                                try:
                                    if data__packagedata_key != "*":
                                        raise JsonSchemaValueException(""
                                                                       + (name_prefix or "data")
                                                                       + ".package-data must be same as const definition: *", value=data__packagedata_key, name=""
                                                                       + (name_prefix or "data")
                                    ...
                                    pass
                            if not data__packagedata_key_any_of_count4:
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".package-data cannot be validated by any definition",
                                                               value=data__packagedata_key,
                                                               name="" + (name_prefix or "data") + ".package-data",
                                                               definition={'anyOf': [{'$id': '#/definitions/package-name',
                                                                                      'title': 'Valid package name',
                                                                                      'description': 'Valid package name (importable or :pep:`561`).',
                                                                                      'type': 'string',
                                                                                      'anyOf': [{'type': 'string',
                    ...
                    if not data__packagedata_property_names:
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".package-data must be named by propertyName definition",
                                                       value=data__packagedata,
                                                       name="" + (name_prefix or "data") + ".package-data",
                                                       definition={'$$description': ['Mapping from package names to lists of glob patterns.',
                                                                                     'Usually this option is not needed when using ``include-package-data = true``',
        ...
        if "include-package-data" in data_keys:
            ...
            if not isinstance(data__includepackagedata, (bool)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".include-package-data must be boolean",
                                               ...
                                               definition={'$$description': ['Automatically include any data files inside the package directories',
                                                                             'that are specified by ``MANIFEST.in``',
                                                                             'For more information on how to include data files, check ``setuptools`` `docs',
                                                                             '<https://setuptools.pypa.io/en/latest/userguide/datafiles.html>`_.'],
                                                           'type': 'boolean'},
        ...
        if "exclude-package-data" in data_keys:
            ...
            if data__excludepackagedata_is_dict:
                ...
                if data__excludepackagedata_keys:
                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".exclude-package-data must not contain " + str(data__excludepackagedata_keys) + " properties",
                                                   value=data__excludepackagedata,
                                                   name="" + (name_prefix or "data") + ".exclude-package-data",
                                                   definition={'$$description': ['Mapping from package names to lists of glob patterns that should be excluded',
                                                                                 'For more information on how to include data files, check ``setuptools`` `docs',
                ...
                if data__excludepackagedata_len != 0:
                    ...
                    for data__excludepackagedata_key in data__excludepackagedata:
                        try:
                            ...
                            if not data__excludepackagedata_key_any_of_count5:
                                try:
                                    validate_https___setuptools_pypa_io_en_latest_userguide_pyproject_config_html__definitions_package_name(
                                        data__excludepackagedata_key, custom_formats, (name_prefix or "data") + ".exclude-package-data")
                            ...
                            if not data__excludepackagedata_key_any_of_count5:
                                try:
                                    ...
                                    pass
                            if not data__excludepackagedata_key_any_of_count5:
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".exclude-package-data cannot be validated by any definition",
                                                               value=data__excludepackagedata_key,
                                                               name="" + (name_prefix or "data") + ".exclude-package-data",
                                                               definition={'anyOf': [{'$id': '#/definitions/package-name',
                                                                                      'title': 'Valid package name',
                    ...
                    if not data__excludepackagedata_property_names:
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".exclude-package-data must be named by propertyName definition",
                                                       value=data__excludepackagedata,
                                                       name="" + (name_prefix or "data") + ".exclude-package-data",
                                                       definition={'$$description': ['Mapping from package names to lists of glob patterns that should be excluded',
                                                                                     'For more information on how to include data files, check ``setuptools`` `docs',
        ...
        if "ext-modules" in data_keys:
            ...
            if not isinstance(data__extmodules, (list, tuple)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".ext-modules must be array",
                                               ...
                                               name="" + (name_prefix or "data") + ".ext-modules",
        ...
        if "data-files" in data_keys:
            ...
            if not isinstance(data__datafiles, (dict)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".data-files must be object",
                                               ...
                                               definition={'$$description': ['``dict``-like structure where each key represents a directory and',
                                                                             'the value is a list of glob patterns that should be installed in them.',
                                                                             '**DISCOURAGED**: please notice this might not work as expected with wheels.',
                                                                             'Whenever possible, consider using data files inside the package directories',
                                                                             '(or create a new namespace package that only contains data files).',
        ...
        if "cmdclass" in data_keys:
            ...
            if not isinstance(data__cmdclass, (dict)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".cmdclass must be object",
                                               ...
                                               definition={'$$description': ['Mapping of distutils-style command names to ``setuptools.Command`` subclasses',
                                                                             'which in turn should be represented by strings with a qualified class name',
                                                                             '(i.e., "dotted" form with module), e.g.::\n\n',
                                                                             '    cmdclass = {mycmd = "pkg.subpkg.module.CommandClass"}\n\n',
                                                                             'The command class should be a directly defined at the top-level of the',
                    ...
                    if REGEX_PATTERNS['^.*$'].search(data__cmdclass_key):
                        ...
                        if not isinstance(data__cmdclass_val, (str)):
                            raise JsonSchemaValueException("" +
                                                           ...
                                                           + " must be string", value=data__cmdclass_val, name=""
                                                           + (name_prefix or "data")
                                                           + ".cmdclass.{data__cmdclass_key}".format(**locals())
                        ...
                        if isinstance(data__cmdclass_val, str):
                            if not custom_formats["python-qualified-identifier"](data__cmdclass_val):
                                raise JsonSchemaValueException("" +
                                                               ...
                                                               + (name_prefix or "data")
                                                               + ".cmdclass.{data__cmdclass_key}".format(**locals())
                                                               + "", definition={'type': 'string', 'format': 'python-qualified-identifier'}, rule='format')
                    ...
                    if data__dynamic__version_one_of_count6 != 1:
                        raise JsonSchemaValueException(
                            "" + (
                                ...
                                " (" + str(data__dynamic__version_one_of_count6) + " matches found)"),
                    ...
                    if data__dynamic__optionaldependencies_is_dict:
                        ...
                        if data__dynamic__optionaldependencies_len != 0:
                            ...
                            if not data__dynamic__optionaldependencies_property_names:
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".dynamic.optional-dependencies must be named by propertyName definition",
                                                               value=data__dynamic__optionaldependencies,
                                                               name="" + (name_prefix or "data")
                                                               + ".dynamic.optional-dependencies",
                                                               definition={'type': 'object',
                            ...
                            if data__dynamic__readme_is_dict:
                                ...
                                if "content-type" in data__dynamic__readme_keys:
                                    ...
                                    if not isinstance(data__dynamic__readme__contenttype, (str)):
                                        raise JsonSchemaValueException(""
                                                                       + (name_prefix or "data")
                                                                       + ".dynamic.readme.content-type must be string", value=data__dynamic__readme__contenttype, name=""
                                                                       + (name_prefix or "data")
                                ...
                                if data__dynamic__readme_keys:
                                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".dynamic.readme must not contain " + str(data__dynamic__readme_keys) + " properties",
                                                                   value=data__dynamic__readme,
                                                                   name="" + (name_prefix or "data") + ".dynamic.readme",
                                                                   definition={'type': 'object',
                                                                               'properties': {'content-type': {'type': 'string'},
...
def validate_https___setuptools_pypa_io_en_latest_userguide_pyproject_config_html__definitions_file_directive(data, custom_formats={
}, name_prefix=None):
    if not isinstance(data, (dict)):
        raise JsonSchemaValueException("" + (name_prefix or "data") + " must be object",
                                       value=data,
            ...
            if data__file_one_of_count9 < 2:
                try:
                    if not isinstance(data__file, (list, tuple)):
                        raise JsonSchemaValueException(""
                                                       + (name_prefix or "data")
                                                       + ".file must be array", value=data__file, name=""
                                                       + (name_prefix or "data")
                                                       + ".file", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
...
def validate_https___setuptools_pypa_io_en_latest_userguide_pyproject_config_html__definitions_attr_directive(data, custom_formats={
}, name_prefix=None):
    if not isinstance(data, (dict)):
        raise JsonSchemaValueException("" + (name_prefix or "data") + " must be object",
                                       value=data,
    ...
    if data_is_dict:
        ...
        if "attr" in data_keys:
            ...
            if not isinstance(data__attr, (str)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".attr must be string",
                                               value=data__attr,
            ...
            if isinstance(data__attr, str):
                if not custom_formats["python-qualified-identifier"](data__attr):
                    raise JsonSchemaValueException(""
                                                   + (name_prefix or "data")
                                                   + ".attr must be python-qualified-identifier", value=data__attr, name=""
                                                   + (name_prefix or "data")
                                                   + ".attr", definition={'type': 'string', 'format': 'python-qualified-identifier'}, rule='format')
        if data_keys:
            raise JsonSchemaValueException(
                "" + (
...
def validate_https___setuptools_pypa_io_en_latest_userguide_pyproject_config_html__definitions_ext_module(data, custom_formats={
}, name_prefix=None):
    if not isinstance(data, (dict)):
        raise JsonSchemaValueException("" + (name_prefix or "data") + " must be object",
                                       value=data,
    ...
    if data_is_dict:
        ...
        if "name" in data_keys:
            ...
            if not isinstance(data__name, (str)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".name must be string",
                                               value=data__name,
            ...
            if isinstance(data__name, str):
                if not custom_formats["python-module-name-relaxed"](data__name):
                    raise JsonSchemaValueException(""
                                                   + (name_prefix or "data")
                                                   + ".name must be python-module-name-relaxed", value=data__name, name=""
                                                   + (name_prefix or "data")
                                                   + ".name", definition={'type': 'string', 'format': 'python-module-name-relaxed'}, rule='format')
        if "sources" in data_keys:
            ...
            if not isinstance(data__sources, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".sources must be array", value=data__sources, name=""
                                               + (name_prefix or "data")
                                               + ".sources", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
        ...
        if "include-dirs" in data_keys:
            ...
            if not isinstance(data__includedirs, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".include-dirs must be array", value=data__includedirs, name=""
                                               + (name_prefix or "data")
                                               + ".include-dirs", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
        ...
        if "define-macros" in data_keys:
            ...
            if not isinstance(data__definemacros, (list, tuple)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".define-macros must be array",
                                               ...
                                               name="" + (name_prefix or "data") + ".define-macros",
                                               definition={'type': 'array',
                                                           'items': {'type': 'array',
                                                                     'items': [{'description': 'macro name',
                                                                                'type': 'string'},
            ...
            if data__definemacros_is_list:
                ...
                for data__definemacros_x, data__definemacros_item in enumerate(data__definemacros):
                    if not isinstance(data__definemacros_item, (list, tuple)):
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".define-macros[{data__definemacros_x}]".format(**locals()) + " must be array", value=data__definemacros_item, name="" + (name_prefix or "data") + ".define-macros[{data__definemacros_x}]".format(
                            **locals()) + "", definition={'type': 'array', 'items': [{'description': 'macro name', 'type': 'string'}, {'description': 'macro value', 'oneOf': [{'type': 'string'}, {'type': 'null'}]}], 'additionalItems': False}, rule='type')
                        ...
                        if data__definemacros_item_len > 1:
                            ...
                            if data__definemacros_item__1_one_of_count10 != 1:
                                raise JsonSchemaValueException("" +
                                                               ...
                                                               + " must be valid exactly by one definition"
                                                               + (" ("
                                                                  + str(data__definemacros_item__1_one_of_count10)
        ...
        if "undef-macros" in data_keys:
            ...
            if not isinstance(data__undefmacros, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".undef-macros must be array", value=data__undefmacros, name=""
                                               + (name_prefix or "data")
                                               + ".undef-macros", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
        ...
        if "library-dirs" in data_keys:
            ...
            if not isinstance(data__librarydirs, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".library-dirs must be array", value=data__librarydirs, name=""
                                               + (name_prefix or "data")
                                               + ".library-dirs", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
        ...
        if "libraries" in data_keys:
            ...
            if not isinstance(data__libraries, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".libraries must be array", value=data__libraries, name=""
                                               + (name_prefix or "data")
                                               + ".libraries", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
        ...
        if "runtime-library-dirs" in data_keys:
            ...
            if not isinstance(data__runtimelibrarydirs, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".runtime-library-dirs must be array", value=data__runtimelibrarydirs, name=""
                                               + (name_prefix or "data")
                                               + ".runtime-library-dirs", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
        ...
        if "extra-objects" in data_keys:
            ...
            if not isinstance(data__extraobjects, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".extra-objects must be array", value=data__extraobjects, name=""
                                               + (name_prefix or "data")
                                               + ".extra-objects", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
        ...
        if "extra-compile-args" in data_keys:
            ...
            if not isinstance(data__extracompileargs, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".extra-compile-args must be array", value=data__extracompileargs, name=""
                                               + (name_prefix or "data")
                                               + ".extra-compile-args", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
        ...
        if "extra-link-args" in data_keys:
            ...
            if not isinstance(data__extralinkargs, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".extra-link-args must be array", value=data__extralinkargs, name=""
                                               + (name_prefix or "data")
                                               + ".extra-link-args", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
        ...
        if "export-symbols" in data_keys:
            ...
            if not isinstance(data__exportsymbols, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".export-symbols must be array", value=data__exportsymbols, name=""
                                               + (name_prefix or "data")
                                               + ".export-symbols", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
        ...
        if "swig-opts" in data_keys:
            ...
            if not isinstance(data__swigopts, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".swig-opts must be array", value=data__swigopts, name=""
                                               + (name_prefix or "data")
                                               + ".swig-opts", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
        ...
        if "depends" in data_keys:
            ...
            if not isinstance(data__depends, (list, tuple)):
                raise JsonSchemaValueException(""
                                               + (name_prefix or "data")
                                               + ".depends must be array", value=data__depends, name=""
                                               + (name_prefix or "data")
                                               + ".depends", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
...
def validate_https___setuptools_pypa_io_en_latest_userguide_pyproject_config_html__definitions_find_directive(data, custom_formats={
}, name_prefix=None):
    if not isinstance(data, (dict)):
        raise JsonSchemaValueException(
            "" + (
            ...
            if data__find_is_dict:
                ...
                if "where" in data__find_keys:
                    ...
                    if not isinstance(data__find__where, (list, tuple)):
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".find.where must be array",
                                                       ...
                                                       definition={'description': 'Directories to be searched for packages (Unix-style relative path)',
                                                                   'type': 'array',
                                                                   'items': {'type': 'string'}},
                                                       rule='type')
                ...
                if "namespaces" in data__find_keys:
                    ...
                    if not isinstance(data__find__namespaces, (bool)):
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".find.namespaces must be boolean",
...
def validate_https___setuptools_pypa_io_en_latest_userguide_pyproject_config_html__definitions_package_name(data, custom_formats={
}, name_prefix=None):
    if not isinstance(data, (str)):
        ...
        try:
            ...
            if isinstance(data, str):
                if not custom_formats["python-module-name-relaxed"](data):
                    raise JsonSchemaValueException(""
                                                   + (name_prefix or "data")
                                                   + " must be python-module-name-relaxed", value=data, name=""
                                                   + (name_prefix or "data")
                                                   + "", definition={'type': 'string', 'format': 'python-module-name-relaxed'}, rule='format')
        ...
        try:
            if not isinstance(data, (str)):
                raise JsonSchemaValueException(""
                                               ...
                                               + " must be string", value=data, name=""
                                               + (name_prefix or "data")
                                               + "", definition={'type': 'string', 'format': 'pep561-stub-name'}, rule='type')
            if isinstance(data, str):
                if not custom_formats["pep561-stub-name"](data):
                    raise JsonSchemaValueException(""
                                                   + (name_prefix or "data")
                                                   + " must be pep561-stub-name", value=data, name=""
                                                   + (name_prefix or "data")
                                                   + "", definition={'type': 'string', 'format': 'pep561-stub-name'}, rule='format')
            data_any_of_count11 += 1
        except JsonSchemaValueException:
            pass
    if not data_any_of_count11:
    ...
    try:
        try:
                        ...
                        for data__dynamic_key in data__dynamic:
                            try:
                                if data__dynamic_key != "version":
                                    raise JsonSchemaValueException(""
                                                                   + (name_prefix or "data")
                                                                   + ".dynamic must be same as const definition: version", value=data__dynamic_key, name=""
                                                                   + (name_prefix or "data")
            ...
            raise JsonSchemaValueException("" + (name_prefix or "data") + " must NOT match a disallowed definition",
                                           value=data,
                                           name="" + (name_prefix or "data") + "",
                                           definition={'not': {'required': ['dynamic'],
                                                               'properties': {'dynamic': {'contains': {'const': 'version'},
                                                                                          '$$description': ['version is listed in ``dynamic``']}}},
                                                       '$$comment': ['According to :pep:`621`:',
                                                                     '    If the core metadata specification lists a field as "Required", then',
        ...
        if data_is_dict:
            ...
            if data__missing_keys:
                raise JsonSchemaValueException("" + (name_prefix or "data") + " must contain " + (str(sorted(data__missing_keys)) + " properties"), value=data, name="" + (
                    name_prefix or "data") + "", definition={'required': ['version'], '$$description': ['version should be statically defined in the ``version`` field']}, rule='required')
    try:
        data_is_dict = isinstance(data, dict)
        if data_is_dict:
            ...
            if data__missing_keys:
                raise JsonSchemaValueException("" +
                                               (name_prefix or "data")
                                               + " must contain "
                                               + (str(sorted(data__missing_keys))
                                                  + " properties"), value=data, name=""
                                               + (name_prefix or "data")
                                               + "", definition={'required': ['license-files']}, rule='required')
    except JsonSchemaValueException:
        pass
    else:
        data_is_dict = isinstance(data, dict)
        if data_is_dict:
            ...
            if "license" in data_keys:
                ...
                if not isinstance(data__license, (str)):
                    raise JsonSchemaValueException(""
                                                   + (name_prefix or "data")
                                                   + ".license must be string", value=data__license, name=""
                                                   + (name_prefix or "data")
                                                   + ".license", definition={'type': 'string'}, rule='type')
    data_is_dict = isinstance(data, dict)
    if data_is_dict:
        ...
        if "readme" in data_keys:
            ...
            if data__readme_one_of_count12 < 2:
                try:
                    ...
                    if not data__readme_any_of_count13:
                        try:
                            ...
                            if data__readme_is_dict:
                                ...
                                if data__readme__missing_keys:
                                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".readme must contain " + (str(sorted(data__readme__missing_keys)) + " properties"), value=data__readme, name="" + (
                                        name_prefix or "data") + ".readme", definition={'properties': {'text': {'type': 'string', 'description': 'Full text describing the project.'}}, 'required': ['text']}, rule='required')
                                data__readme_keys = set(data__readme.keys())
                            ...
                            pass
                    if not data__readme_any_of_count13:
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".readme cannot be validated by any definition",
                                                       value=data__readme,
                                                       name="" + (name_prefix or "data") + ".readme",
                    ...
                    if data__readme_is_dict:
                        ...
                        if data__readme__missing_keys:
                            raise JsonSchemaValueException("" + (name_prefix or "data") + ".readme must contain " + (str(sorted(data__readme__missing_keys)) + " properties"),
                                                           value=data__readme,
                                                           name="" + (name_prefix or "data") + ".readme",
            ...
            if data__readme_one_of_count12 != 1:
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".readme must be valid exactly by one definition" + (" (" + str(data__readme_one_of_count12) + " matches found)"),
                                               value=data__readme,
                                               name="" + (name_prefix or "data") + ".readme",
        ...
        if "requires-python" in data_keys:
            ...
            if isinstance(data__requirespython, str):
                if not custom_formats["pep508-versionspec"](data__requirespython):
                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".requires-python must be pep508-versionspec",
                                                   value=data__requirespython,
                                                   name="" + (name_prefix or "data") + ".requires-python",
                                                   definition={'type': 'string',
                                                               'format': 'pep508-versionspec',
        ...
        if "license" in data_keys:
            ...
            if data__license_one_of_count14 < 2:
                try:
                    if not isinstance(data__license, (str)):
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".license must be string",
                                                       value=data__license,
                    ...
                    if isinstance(data__license, str):
                        if not custom_formats["SPDX"](data__license):
                            raise JsonSchemaValueException("" + (name_prefix or "data") + ".license must be SPDX",
                                                           value=data__license,
                                                           name="" + (name_prefix or "data") + ".license",
                                                           definition={'type': 'string',
                                                                       'description': 'An SPDX license identifier',
            ...
            if data__license_one_of_count14 < 2:
                try:
                    if not isinstance(data__license, (dict)):
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".license must be object",
                                                       value=data__license,
                                                       name="" + (name_prefix or "data") + ".license",
                                                       definition={'type': 'object',
                                                                   'properties': {'file': {'type': 'string',
                    ...
                    if data__license_is_dict:
                        ...
                        if "file" in data__license_keys:
                            ...
                            if not isinstance(data__license__file, (str)):
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".license.file must be string",
                    ...
                    if data__license_is_dict:
                        ...
                        if "text" in data__license_keys:
                            ...
                            if not isinstance(data__license__text, (str)):
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".license.text must be string",
            ...
            if data__license_one_of_count14 != 1:
                raise JsonSchemaValueException(
                    "" + (
                        ...
                        " (" + str(data__license_one_of_count14) + " matches found)"),
                    value=data__license,
                    name="" + (
                        name_prefix or "data") + ".license",
                    definition={
        ...
        if "license-files" in data_keys:
            ...
            if not isinstance(data__licensefiles, (list, tuple)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".license-files must be array",
                                               value=data__licensefiles,
                                               name="" + (name_prefix or "data") + ".license-files",
                                               definition={'description': 'Paths or globs to paths of license files',
                                                           'type': 'array',
                                                           'items': {'type': 'string'}},
                                               rule='type')
            data__licensefiles_is_list = isinstance(data__licensefiles, (list, tuple))
        ...
        if "maintainers" in data_keys:
            ...
            if data__maintainers_is_list:
                ...
                for data__maintainers_x, data__maintainers_item in enumerate(data__maintainers):
                    validate_https___packaging_python_org_en_latest_specifications_pyproject_toml___definitions_author(
                        data__maintainers_item, custom_formats, (name_prefix or "data") + ".maintainers[{data__maintainers_x}]".format(**locals()))
                        ...
                        if isinstance(data__urls_val, str):
                            if not custom_formats["url"](data__urls_val):
                                raise JsonSchemaValueException("" +
                                                               (name_prefix or "data")
                                                               + ".urls.{data__urls_key}".format(**locals())
                                                               + " must be url", value=data__urls_val, name=""
                                                               + (name_prefix or "data")
                                                               + ".urls.{data__urls_key}".format(**locals())
                                                               + "", definition={'type': 'string', 'format': 'url'}, rule='format')
                if data__urls_keys:
                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".urls must not contain " + str(data__urls_keys) + " properties",
                                                   value=data__urls,
                                                   name="" + (name_prefix or "data") + ".urls",
                                                   definition={'type': 'object',
                                                               'description': 'URLs associated with the project in the form ``label => value``.',
        ...
        if "entry-points" in data_keys:
            ...
            if data__entrypoints_is_dict:
                ...
                if data__entrypoints_keys:
                    raise JsonSchemaValueException(
                        "" + (
                            name_prefix or "data") + ".entry-points must not contain " + str(data__entrypoints_keys) + " properties",
                        value=data__entrypoints,
                        name="" + (
                            name_prefix or "data") + ".entry-points",
                        definition={
                            '$$description': [
                        ...
                        try:
                            if isinstance(data__entrypoints_key, str):
                                if not custom_formats["python-entrypoint-group"](data__entrypoints_key):
                                    raise JsonSchemaValueException(""
                                                                   + (name_prefix or "data")
                                                                   + ".entry-points must be python-entrypoint-group", value=data__entrypoints_key, name=""
                                                                   + (name_prefix or "data")
                                                                   + ".entry-points", definition={'format': 'python-entrypoint-group'}, rule='format')
                        except JsonSchemaValueException:
                            data__entrypoints_property_names = False
                    if not data__entrypoints_property_names:
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".entry-points must be named by propertyName definition",
                                                       value=data__entrypoints,
                                                       name="" + (name_prefix or "data") + ".entry-points",
                                                       definition={'$$description': ['Instruct the installer to expose the given modules/functions via',
                                                                                     '``entry-point`` discovery mechanism (useful for plugins).',
                                                                                     'More information available in the `Python packaging guide',
                                                                                     '<https://packaging.python.org/specifications/entry-points/>`_.'],
                                                                   'propertyNames': {'format': 'python-entrypoint-group'},
            ...
            if data__dependencies_is_list:
                ...
                for data__dependencies_x, data__dependencies_item in enumerate(data__dependencies):
                    validate_https___packaging_python_org_en_latest_specifications_pyproject_toml___definitions_dependency(
                        data__dependencies_item, custom_formats, (name_prefix or "data") + ".dependencies[{data__dependencies_x}]".format(**locals()))
                        ...
                        try:
                            if isinstance(data__optionaldependencies_key, str):
                                if not custom_formats["pep508-identifier"](data__optionaldependencies_key):
                                    raise JsonSchemaValueException(""
                                                                   + (name_prefix or "data")
                                                                   + ".optional-dependencies must be pep508-identifier", value=data__optionaldependencies_key, name=""
                                                                   + (name_prefix or "data")
                                                                   + ".optional-dependencies", definition={'format': 'pep508-identifier'}, rule='format')
                        except JsonSchemaValueException:
        ...
        if "import-names" in data_keys:
            ...
            if not isinstance(data__importnames, (list, tuple)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".import-names must be array",
                                               value=data__importnames,
                                               name="" + (name_prefix or "data") + ".import-names",
                                               definition={'description': 'Lists import names which a project, when installed, would exclusively provide.',
                                                           'type': 'array',
                                                           'items': {'type': 'string',
                                                                     'format': 'import-name'}},
                                               rule='type')
            ...
            if data__importnames_is_list:
                ...
                for data__importnames_x, data__importnames_item in enumerate(data__importnames):
                    if not isinstance(data__importnames_item, (str)):
                        raise JsonSchemaValueException("" +
                                                       (name_prefix or "data")
                                                       + ".import-names[{data__importnames_x}]".format(**locals())
                                                       + " must be string", value=data__importnames_item, name=""
                                                       + (name_prefix or "data")
                                                       + ".import-names[{data__importnames_x}]".format(**locals())
                                                       + "", definition={'type': 'string', 'format': 'import-name'}, rule='type')
                    if isinstance(data__importnames_item, str):
                        if not custom_formats["import-name"](data__importnames_item):
                            raise JsonSchemaValueException("" +
                                                           (name_prefix or "data")
                                                           + ".import-names[{data__importnames_x}]".format(**locals())
                                                           + " must be import-name", value=data__importnames_item, name=""
                                                           + (name_prefix or "data")
                                                           + ".import-names[{data__importnames_x}]".format(**locals())
                                                           + "", definition={'type': 'string', 'format': 'import-name'}, rule='format')
        if "import-namespaces" in data_keys:
            ...
            if not isinstance(data__importnamespaces, (list, tuple)):
                raise JsonSchemaValueException(
                    ...
                    + (
                        name_prefix or "data")
                    + ".import-namespaces must be array",
                    value=data__importnamespaces,
                    name=""
                    + (
                        name_prefix or "data")
                    + ".import-namespaces",
            ...
            if data__importnamespaces_is_list:
                ...
                for data__importnamespaces_x, data__importnamespaces_item in enumerate(data__importnamespaces):
                    if not isinstance(data__importnamespaces_item, (str)):
                        raise JsonSchemaValueException("" +
                                                       (name_prefix or "data")
                                                       + ".import-namespaces[{data__importnamespaces_x}]".format(**locals())
                                                       + " must be string", value=data__importnamespaces_item, name=""
                                                       + (name_prefix or "data")
                                                       + ".import-namespaces[{data__importnamespaces_x}]".format(**locals())
                                                       + "", definition={'type': 'string', 'format': 'import-name'}, rule='type')
                    if isinstance(data__importnamespaces_item, str):
                        if not custom_formats["import-name"](data__importnamespaces_item):
                            raise JsonSchemaValueException("" +
                                                           (name_prefix or "data")
                                                           + ".import-namespaces[{data__importnamespaces_x}]".format(**locals())
                                                           + " must be import-name", value=data__importnamespaces_item, name=""
                                                           + (name_prefix or "data")
                                                           + ".import-namespaces[{data__importnamespaces_x}]".format(**locals())
                                                           + "", definition={'type': 'string', 'format': 'import-name'}, rule='format')
        if "dynamic" in data_keys:
            ...
            if data__dynamic_is_list:
                ...
                for data__dynamic_x, data__dynamic_item in enumerate(data__dynamic):
                    if data__dynamic_item not in ['version', 'description', 'readme', 'requires-python', 'license', 'license-files', 'authors', 'maintainers', 'keywords',
                                                  'classifiers', 'urls', 'scripts', 'gui-scripts', 'entry-points', 'dependencies', 'optional-dependencies', 'import-names', 'import-namespaces']:
                        raise JsonSchemaValueException(
                            ""
                            + (
                                name_prefix or "data")
                            + ".dynamic[{data__dynamic_x}]".format(
                                **locals())
                            + " must be one of ['version', 'description', 'readme', 'requires-python', 'license', 'license-files', 'authors', 'maintainers', 'keywords', 'classifiers', 'urls', 'scripts', 'gui-scripts', 'entry-points', 'dependencies', 'optional-dependencies', 'import-names', 'import-namespaces']",
...
def validate_https___packaging_python_org_en_latest_specifications_pyproject_toml___definitions_dependency(data, custom_formats={
}, name_prefix=None):
    if not isinstance(data, (str)):
        raise JsonSchemaValueException("" + (name_prefix or "data") + " must be string",
                                       value=data,
                                       name="" + (name_prefix or "data") + "",
                                       definition={'$id': '#/definitions/dependency',
                                                   'title': 'Dependency',
                                                   'type': 'string',
                                                   'description': 'Project dependency specification according to PEP 508',
                                                   'format': 'pep508'},
    ...
    if isinstance(data, str):
        if not custom_formats["pep508"](data):
            raise JsonSchemaValueException("" + (name_prefix or "data") + " must be pep508",
                                           value=data,
                                           name="" + (name_prefix or "data") + "",
                                           definition={'$id': '#/definitions/dependency',
                                                       'title': 'Dependency',
...
def validate_https___packaging_python_org_en_latest_specifications_pyproject_toml___definitions_entry_point_group(data, custom_formats={
}, name_prefix=None):
    if not isinstance(data, (dict)):
        raise JsonSchemaValueException("" + (name_prefix or "data") + " must be object",
                                       value=data,
                                       name="" + (name_prefix or "data") + "",
                                       definition={'$id': '#/definitions/entry-point-group',
                                                   'title': 'Entry-points',
                                                   'type': 'object',
                                                   '$$description': ['Entry-points are grouped together to indicate what sort of capabilities they',
                                                                     'provide.',
                ...
                try:
                    if isinstance(data_key, str):
                        if not custom_formats["python-entrypoint-name"](data_key):
                            raise JsonSchemaValueException(""
                                                           + (name_prefix or "data")
                                                           + " must be python-entrypoint-name", value=data_key, name=""
                                                           + (name_prefix or "data")
                                                           + "", definition={'format': 'python-entrypoint-name'}, rule='format')
                except JsonSchemaValueException:
                    data_property_names = False
            if not data_property_names:
                raise JsonSchemaValueException("" + (name_prefix or "data") + " must be named by propertyName definition",
                                               value=data,
                                               name="" + (name_prefix or "data") + "",
                                               definition={'$id': '#/definitions/entry-point-group',
                                                           'title': 'Entry-points',
...
def validate_https___packaging_python_org_en_latest_specifications_pyproject_toml___definitions_author(data, custom_formats={
}, name_prefix=None):
    if not isinstance(data, (dict)):
        raise JsonSchemaValueException("" + (name_prefix or "data") + " must be object",
                                       value=data,
                                       name="" + (name_prefix or "data") + "",
                                       definition={'$id': '#/definitions/author',
                                                   'title': 'Author or Maintainer',
                                                   '$comment': 'https://peps.python.org/pep-0621/#authors-maintainers',
                                                   'type': 'object',
                                                   'additionalProperties': False,
                ...
                if data__missing_keys:
                    raise JsonSchemaValueException("" +
                                                   ...
                                                   + (str(sorted(data__missing_keys))
                                                      + " properties"), value=data, name=""
                                                   + (name_prefix or "data")
                                                   + "", definition={'required': ['name']}, rule='required')
                ...
                if data__missing_keys:
                    raise JsonSchemaValueException("" +
                                                   ...
                                                   + (str(sorted(data__missing_keys))
                                                      + " properties"), value=data, name=""
                                                   + (name_prefix or "data")
                                                   + "", definition={'required': ['email']}, rule='required')
            data_any_of_count15 += 1
        except JsonSchemaValueException:
            pass
    if not data_any_of_count15:
